...
class MyTradingFunctions():
    ...
    ##############################################################################
        ...
        return [ask_mom1Dict, ask_mom2Dict, ask_ma1Dict, ask_ma2Dict, ask_moving20_sdev, ask_rsi_5, ask_moving50_max, ask_ema_10,ask_ema_20,
                bid_mom1Dict, bid_mom2Dict, bid_ma1Dict, bid_ma2Dict, bid_moving20_sdev, bid_rsi_5,bid_moving50_max,bid_ema_10,bid_ema_20]
